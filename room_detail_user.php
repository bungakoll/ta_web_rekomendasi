...
<body>
    ...
    <header>
        <div class="container">
            ...
            <nav class="col--md-9 col-sm-9 col-xs-9">
                ...
                <div class="main-menu">
                    <div id="header_menu">
                        <img src="img/koll.png" width="1000" height="500">
                    </div>
    ...
    <div class="carousel_in">
        <div><img src="img/room_detail_1.jpg" alt="">
            <div class="caption">
                <h3>Fantastic bed room</h3>
            </div>
        </div>
        <div><img src="img/room_detail_2.jpg" alt="">
            <div class="caption">
                <h3>Equiped bathroom</h3>
            </div>
        </div>
        <div><img src="img/room_detail_3.jpg" alt="">
            <div class="caption">
                <h3>Equiped bathroom</h3>
            </div>
        </div>
        <div><img src="img/room_detail_4.jpg" alt="">
            <div class="caption">
                <h3>Nice outdoor</h3>
            </div>
        </div>
        <div><img src="img/room_detail_5.jpg" alt="">
            <div class="caption">
                <h3>Swimming pool</h3>
            </div>
        </div>
    ...
    <div class="container add_bottom_60">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <p>
                            Whiz Prime Hotel Basuki Rahmat Malang merupakan pilihan yang tepat ketika mengunjungi Malang, karena menawarkan suasana yang sesuai untuk keluarga ditambah dengan fasilitas akan menyempurnakan masa menginap Anda.

                            Karena berdekatan dengan beberapa tempat terkenal, seperti Tugu Batu Bukit Panderman (0,8 km) dan Stadion Kanjuruhan (0,9 km), para tamu Whiz Prime Hotel Basuki Rahmat Malang dapat mengunjungi beberapa lokasi populer di Malang.

                            Kamar tamu memiliki penyejuk udara dan meja, dan Whiz Prime Hotel Basuki Rahmat Malang membuat terhubung dengan internet semakin mudah karena menawarkan wi-fi gratis.
                        </p>
