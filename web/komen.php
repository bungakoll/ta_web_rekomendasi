...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col--md-3 col-sm-3 col-xs-3">
                ...
                <img src="img/koll.png" width="190" height="23" alt="" data-retina="true">
                </a>
            </div>
            <nav class="col--md-9 col-sm-9 col-xs-9">
            <a class="cmn-toggle-switch cmn-toggle-switch__htx open_close" href="javascript:void(0);"><span>Menu mobile</span></a>
            <ul id="lang_top">
                <li><a href="home.html" class="active">KOLL-TAG</a></li>
            </ul>
            <div class="main-menu">
                <div id="header_menu">
                     <img src="img/koll.png" width="141" height="40" alt="" data-retina="true">
                </div>
                <a href="#" class="open_close" id="close_in"><i class="icon_set_1_icon-77"></i></a>
                 <ul>
                    <li><a href="home.html">Home</a></li>
                    <li><a href="rekomen.html">ruangan</a></li>
                    <li><a href="komen.html">komen</a></li>
            </div><!-- End main-menu -->
    ...
    <!-- SubHeader =============================================== -->
    <section class="parallax-window" id="short" data-parallax="scroll" data-image-src="img/ceper.png" data-natural-width="1500" data-natural-height="500">
    </div><!-- End subheader -->
    </section><!-- End section -->
    <!-- End SubHeader ============================================ -->
