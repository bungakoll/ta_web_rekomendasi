    ...
    <div class="container">
            ...
            <div class="main-menu">
                ...
                <a href="#" class="open_close" id="close_in"><i class="icon_set_1_icon-77"></i></a>
                 <ul>
                    <li class="submenu">
                    <a href="javascript:void(0);" class="show-submenu" style="color: #DDF7FF;">Home<i class=></i></a>
                    </li>
                    <li><a href="rekomen.php" style="color: #DDF7FF;">ruangan</a></li>
                    <li><a href="komen.php" style="color: #DDF7FF;">komen</a></li>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
					...
					<ul id="contact_details_footer">
                        ...
                        <li><a href="tel://0895344173441"> 0895344173441</a> / <a href="#0"><script data-cfhash='f9e31' type="text/javascript">/* <![CDATA[ */!function(t,e,r,n,c,a,p){try{t=document.currentScript||function(){for(t=document.getElementsByTagName('script'),e=t.length;e--;)if(t[e].getAttribute('data-cfhash'))return t[e]}();if(t&&(c=t.previousSibling)){p=t.parentNode;if(a=c.getAttribute('data-cfemail')){for(e='',r='0x'+a.substr(0,2)|0,n=2;a.length-n;n+=2)e+='%'+('0'+('0x'+a.substr(n,2)^r).toString(16)).slice(-2);p.replaceChild(document.createTextNode(decodeURIComponent(e)),c)}p.removeChild(t)}}catch(u){}}()/* ]]> */</script></a></li>
                    </ul>  
                </div>
frenchc                <div class="col-md-2 col-sm-4">
                    <h3>rekomendasi hotel</h3>
                    <ul>
                        <li><a href="room_list.html">recomend</a></li>
                    </ul>
                </div>                
